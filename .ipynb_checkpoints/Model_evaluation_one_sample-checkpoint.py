...
MODEL_PATH = f"SPT_checkpoints/{model_weight_path}/sl_model_349.pth"
...
def run_ai_solver(model, problem_file, workpieces_objs, machine_power_data, device, batch_size=64):
...
def main():
    ...
    gantt_dir = Path("Gantt_Charts_TestSet_GA_Trained_Diffusion_350_BS64")
    ...
    save_to_csv(csv_data_model, f"result_testset_{model_weight_path}_350_BS64.csv")
