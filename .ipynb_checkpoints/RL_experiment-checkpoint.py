...
def draw_gantt_chart(schedule, filename, makespan):
    """
    绘制 Gantt 图
    ...
    for item in schedule:
        ...
        ax.barh(y=m_id, width=duration, left=start, 
                ...
                color=job_color_map[job_id], edgecolor='black', alpha=0.8)
        
        # 在条形中间添加文本 (例如: J1)
        ax.text(start + duration/2, m_id, f"J{job_id}", 
